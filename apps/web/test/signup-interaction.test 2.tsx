...
describe("signup screen interaction", () => {
  ...
  it("announces a safe provider error through an accessible alert", async () => {
    const user = userEvent.setup();
    ...
    expect(alert.textContent).toContain(
      "Kata sandi ini pernah bocor di kebocoran data lain",
    );
    // Never leaks the raw Clerk error code to the user.
