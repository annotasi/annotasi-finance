...
export default function ForgotPasswordPage() {
  ...
  async function onSubmitRequest(
    ...
    try {
      ...
      if (createError && !ACCOUNT_LOOKUP_ERROR_CODES.has(createError.code)) {
        setErrorMessage(safeClerkErrorMessage(createError.code));
        return;
      }
      ...
      if (!createError) {
        ...
        if (
          sendCodeError &&
          !ACCOUNT_LOOKUP_ERROR_CODES.has(sendCodeError.code)
        ) {
          setErrorMessage(safeClerkErrorMessage(sendCodeError.code));
          return;
        }
      }
  ...
  async function onSubmitReset(
    ...
    try {
      ...
      if (verifyError) {
        setErrorMessage(safeClerkErrorMessage(verifyError.code));
        return;
      }
      ...
      if (submitError) {
        setErrorMessage(safeClerkErrorMessage(submitError.code));
        return;
      }
